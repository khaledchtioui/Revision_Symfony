...
class ClubController extends AbstractController
{
    ...
    #[Route('/getname/{nom}', name: 'app_name')]
    public function getName($nom): Response
    {
        return $this->render('club/detail.html.twig',array("nom"=>$nom)
...
4','Description'=>'formation pratique',
        ...
        return $this->render('club/list.html.twig',array("tab"=>$formations,"v1"=>$v1,"v2"=>$v2)
